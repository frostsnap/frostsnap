                ...
                match restoration {
                    ...
                    EnterBackup { phase } => {
                        ...
                        if self.enter_invalid_backup {
                            // Use a fixed valid backup string that will be invalid for this context
                            // This is a valid 2-of-3 backup but won't match the expected shared key
                            share_backup = "#1 TIRED CREEK REAL UNFOLD CARBON EIGHT ENDORSE JAGUAR FEEL ROSE HAMSTER SAY PARTY SATISFY CRUISE CLOUD YEAR NUCLEAR SAD VISUAL GRIT NOODLE LEFT BALANCE REVEAL".parse()
                                .expect("Fixed backup should parse");
                        }
