...
fn wire_new_ffi_coordinator_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, RustOpaque<FfiCoordinator>>(
        WrapInfo {
        ...
        move || {
            ...
            move |task_callback| Ok(new_ffi_coordinator(api_host_handles_serial))
        },
    )
}
fn wire_turn_stderr_logging_on_impl(port_: MessagePort, level: impl Wire2Api<Level> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        ...
        move || {
            ...
            move |task_callback| Ok(turn_stderr_logging_on(api_level))
        },
    )
}
fn wire_turn_logcat_logging_on_impl(port_: MessagePort, _level: impl Wire2Api<Level> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        ...
        move || {
            ...
            move |task_callback| Ok(turn_logcat_logging_on(api__level))
        },
    )
}
fn wire_announce_available_ports_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        ...
        move || {
            ...
            move |task_callback| Ok(announce_available_ports(api_coordinator, api_ports))
        },
    )
}
fn wire_set_device_label_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        ...
        move || {
            ...
            move |task_callback| Ok(set_device_label(api_coordinator, api_device_id, api_label))
        },
    )
}
fn wire_satisfy__method__PortOpen_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        ...
        move || {
            ...
            move |task_callback| Ok(PortOpen::satisfy(&api_that, api_err))
        },
    )
}
fn wire_satisfy__method__PortRead_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        ...
        move || {
            ...
            let api_err = err.wire2api();
            move |task_callback| Ok(PortRead::satisfy(&api_that, api_bytes, api_err))
        },
    )
}
fn wire_satisfy__method__PortWrite_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        ...
        move || {
            let api_that = that.wire2api();
            let api_err = err.wire2api();
            move |task_callback| Ok(PortWrite::satisfy(&api_that, api_err))
        },
    )
}
fn wire_satisfy__method__PortBytesToRead_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, ()>(
        ...
        move || {
            ...
            move |task_callback| Ok(PortBytesToRead::satisfy(&api_that, api_bytes_to_read))
        },
    )
}
