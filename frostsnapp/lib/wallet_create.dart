...
class WalletCreateController extends ChangeNotifier {
  ...
  InlineSpan get title => switch (_step) {
    ...
    WalletCreateStep.nonceReplenish => TextSpan(text: "Preparing devices"),
  ...
  TextSpan get subtitle => switch (_step) {
    ...
    WalletCreateStep.nonceReplenish => TextSpan(
      text: "Preparing devices for future signing sessions.",
    ),
