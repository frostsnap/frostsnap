...
class _DoKeyGenScreenState extends State<DoKeyGenScreen> {
  ...
  Future<void> showBackupDialogue({required KeyId keyId}) async {
    ...
    final polynomialIdentifier =
        api.getShareCompatibilityIdentifier(frostKey: frostKey);
              ...
              child: Align(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 16),
                    Text(
                        "Alongside each backup, also record the threshold and identifier."),
                    SizedBox(height: 8),
                    Text(
