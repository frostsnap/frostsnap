...
class _DeviceDetailsState extends State<DeviceDetails> {
  ...
  Widget _buildColumn(BuildContext context, ConnectedDevice device) {
    ...
    final revision = device.revision;
    ...
    final advancedHidden = [
      if (serialNumber != null)
        ListTile(
          ...
          subtitle: Text(serialNumber, style: monospaceTextStyle),
          leading: Icon(Icons.tag_rounded, color: colors.accent),
          onTap: () => copyAction(context, 'Serial number', serialNumber),
        ),
      if (revision != null)
        ListTile(
          contentPadding: EdgeInsets.symmetric(horizontal: 16),
          title: Text('Board Revision'),
          subtitle: Text(revision, style: monospaceTextStyle),
          leading: Icon(Icons.developer_board_rounded, color: colors.accent),
          onTap: () => copyAction(context, 'Board revision', revision),
        ),
      ListTile(
        contentPadding: EdgeInsets.symmetric(horizontal: 16),
