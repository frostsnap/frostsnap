...
class NativeWire implements FlutterRustBridgeWireBase {
  ...
  WireSyncReturn wire_get_key(
    ffi.Pointer<wire_KeyId> key_id,
  ) {
    return _wire_get_key(
      key_id,
    );
  }

  late final _wire_get_keyPtr = _lookup<
          ffi.NativeFunction<WireSyncReturn Function(ffi.Pointer<wire_KeyId>)>>(
      'wire_get_key');
  late final _wire_get_key = _wire_get_keyPtr
      .asFunction<WireSyncReturn Function(ffi.Pointer<wire_KeyId>)>();
  ...
  late final _wire_start_signingPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64,
              ffi.Pointer<wire_KeyId>,
              ffi.Pointer<wire_list_device_id>,
              ffi.Pointer<wire_uint_8_list>)>>('wire_start_signing');
  late final _wire_start_signing = _wire_start_signingPtr.asFunction<
      void Function(int, ffi.Pointer<wire_KeyId>,
          ffi.Pointer<wire_list_device_id>, ffi.Pointer<wire_uint_8_list>)>();
