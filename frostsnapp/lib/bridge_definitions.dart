...
@freezed
sealed class CoordinatorToUserSigningMessage
    with _$CoordinatorToUserSigningMessage {
  const factory CoordinatorToUserSigningMessage.gotShare({
    required DeviceId from,
  }) = CoordinatorToUserSigningMessage_GotShare;
  const factory CoordinatorToUserSigningMessage.signed({
    required List<EncodedSignature> signatures,
  }) = CoordinatorToUserSigningMessage_Signed;
}
