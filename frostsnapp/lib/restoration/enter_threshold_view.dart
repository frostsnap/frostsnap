...
/// Parent triggers submission via a [GlobalKey<EnterThresholdViewState>]
/// + `currentState!.submit()`, which keeps the form state local to the
/// view instead of hoisting it onto the controller.
class EnterThresholdView extends StatefulWidget {
  final int? initialThreshold;
  final void Function(int? threshold) onSubmit;
  ...
  @override
  State<EnterThresholdView> createState() => EnterThresholdViewState();
}

class EnterThresholdViewState extends State<EnterThresholdView> {
    ...
    return Focus(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            Text(
              'If you know the threshold of the wallet, enter it here. '
              'Otherwise, we will determine it as we go.',
              ...
              child: Column(
                children: [
                  ...
                  Card.outlined(
                    child: InkWell(
                      onTap: () {
                        setState(() => _specifyThreshold = true);
