...
// Section: api2wire
  ...
  @protected
  Object api2wire_ArcChainSync(ArcChainSync raw) {
  ...
  @protected
  List<dynamic> api2wire_box_autoadd_wallet_loader(WalletLoader raw) {
    return api2wire_wallet_loader(raw);
  }
  ...
  List<dynamic> api2wire_wallet(Wallet raw) {
    return [
      ...
      api2wire_ArcChainSync(raw.chainSync),
      api2wire_bitcoin_network(raw.network)
    ];
  }

  @protected
  List<dynamic> api2wire_wallet_loader(WalletLoader raw) {
    return [
      api2wire_String(raw.directory),
      api2wire_MutexHashMapRBitcoinNetworkWallet(raw.loaded)
    ];
  }
// Section: finalizer

  late final Finalizer<PlatformPointer> _ArcChainSyncFinalizer =
      Finalizer<PlatformPointer>(inner.drop_opaque_ArcChainSync);
  Finalizer<PlatformPointer> get ArcChainSyncFinalizer =>
      _ArcChainSyncFinalizer;
...
class NativeWasmModule implements WasmModule {
  ...
  external dynamic /* void */ wire_create__static_method__WalletLoader(
      NativePortType port_, String directory);

  external dynamic /* void */ wire_load__method__WalletLoader(
  ...
  external dynamic /*  */ drop_opaque_ArcChainSync(ptr);

  external int /* *const c_void */ share_opaque_ArcChainSync(ptr);
...
class NativeWire extends FlutterRustBridgeWasmWireBase<NativeWasmModule> {
  ...
  void wire_create__static_method__WalletLoader(
          NativePortType port_, String directory) =>
      wasmModule.wire_create__static_method__WalletLoader(port_, directory);

  void wire_load__method__WalletLoader(
          NativePortType port_, List<dynamic> that, List<dynamic> network) =>
      wasmModule.wire_load__method__WalletLoader(port_, that, network);
  ...
  dynamic /*  */ drop_opaque_ArcChainSync(ptr) =>
      wasmModule.drop_opaque_ArcChainSync(ptr);

  int /* *const c_void */ share_opaque_ArcChainSync(ptr) =>
      wasmModule.share_opaque_ArcChainSync(ptr);
