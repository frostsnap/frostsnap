...
class NativeWasmModule implements WasmModule {
  ...
  external dynamic /* void */ wire_start_signing(NativePortType port_,
      List<dynamic> key_id, List<dynamic> devices, String message);
...
class NativeWire extends FlutterRustBridgeWasmWireBase<NativeWasmModule> {
  ...
  void wire_start_signing(NativePortType port_, List<dynamic> key_id,
          List<dynamic> devices, String message) =>
      wasmModule.wire_start_signing(port_, key_id, devices, message);
