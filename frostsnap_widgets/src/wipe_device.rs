use crate::{
    any_of::AnyOf, gray4_style::Gray4TextStyle, palette::PALETTE, Center, Column, CrossAxisAlignment,
...
impl WipeWarningPage {
    fn new() -> Self {
        ...
        let warning_text = Text::new(
            "Warning".to_string(),
            Gray4TextStyle::new(&frostsnap_fonts::NOTO_SANS_18_MEDIUM, WIPE_BUTTON_BORDER_COLOR), // Same red as border
        );
        ...
        let warning_line1 = Text::new(
            ...
            Gray4TextStyle::new(&frostsnap_fonts::NOTO_SANS_17_REGULAR, PALETTE.text_secondary),
        );
