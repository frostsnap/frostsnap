...
impl Commands {
    pub fn run(
        &self,
        wallet: &mut coordinator_core::wallet::Wallet,
        db: &mut coordinator_core::db::Db,
        ports: &mut coordinator_core::ports::Ports,
        network: Network,
    ) -> anyhow::Result<()> {
        ...
        match self {
            Commands::Sync => {
                ...
                let changeset = coordinator_core::wallet::ChangeSet {
            ...
            Commands::Send {
                ...
                let mut signer = coordinator_core::signer::Signer::new(db, ports, coordinator);
