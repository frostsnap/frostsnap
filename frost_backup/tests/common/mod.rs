...
/// The same 1-of-1 secret as a `#0` bare-secret backup
/// Secret used: 0x0101010101010101010101010101010101010101010101010101010101010101
pub const TEST_BARE_SECRET: &str = "#0 ABSURD AMOUNT DOCTOR ACOUSTIC AVOID LETTER ADVICE CAGE ABSURD AMOUNT DOCTOR ACOUSTIC AVOID LETTER ADVICE CAGE ABSURD AMOUNT DOCTOR ACOUSTIC AVOID LETTER ADVICE CHECK WIDTH";
