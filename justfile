...
save-image BOARD=default_board +ARGS="":
    espflash save-image --chip=esp32c3 device/target/riscv32imc-unknown-none-elf/release/{{BOARD}} device/target/riscv32imc-unknown-none-elf/release/firmware.bin {{ARGS}}
