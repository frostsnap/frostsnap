use crate::{
    ...
    any_of::AnyOf, bitcoin_amount_display::BitcoinAmountDisplay, center::Center, icons::IconWidget, Column, CrossAxisAlignment, MainAxisAlignment, page_slider::PageSlider, widget_list::WidgetList, sized_box::SizedBox, text::Text, DynWidget, Instant, Padding, Widget, HoldToConfirm, palette::PALETTE
};
...
type AddressDisplayWidget = AnyOf<(crate::p2tr_address_display::P2trAddressDisplay, Text<U8g2TextStyle<Rgb565>>)>;
