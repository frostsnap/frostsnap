use crate::{
    alignment::Align, container::Container, icons::IconWidget, palette::PALETTE, text::Text,
    touch_listener::TouchListener, Column, Key, Padding, Row, FONT_MED,
};
...
pub struct NumericKeyboard {
    #[widget_delegate]
    keyboard: Padding<Column<(NumericRow, NumericRow, NumericRow, BottomRow)>>,
}
