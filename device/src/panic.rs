...
pub fn handle_panic(info: &core::panic::PanicInfo) -> ! {
    // Enter critical section immediately to disable all interrupts
    // This prevents double panics from UART or other interrupts
    ...
    // Loop forever after critical section ends
    // Interrupts remain disabled because we're in a panic
